                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                    <div class="modal-content modal-filled bg-white">
                                        <div class="modal-body text-dark">
                                            Ceci represente touts les liste des Personnages dans la base données
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="card-subtitle">
                                Bienvenue dans la section Listes Des Personnages. Ici, vous pouvez voir tous les
                                personnages enregistrés dans le système de notre université. Cette section vous permet
                                de consulter leurs détails.
                            </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="font-bold link"
                                                   href="matricule/{{ $personne->student_id }}">{{ $personne->student_id }}</a>
                                            </td>
                                            <td class="text-uppercase">{{ $personne->student_nom }}</td>
                                            <td>{{ $personne->student_prenom }}</td>
                                            <td>{{ $personne->etude_envisage }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
