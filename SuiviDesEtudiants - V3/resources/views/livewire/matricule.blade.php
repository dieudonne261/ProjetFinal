            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div
                            style="background-image: url(../assets/images/profil-back{{ ($personne->sex == 'M' || $personne->sex == 'Masculin' || $personne->sex == '1') ? 'M' : 'F' }}.jpg); background-size: cover; border-radius: 10px; margin-bottom: 90px;">
                            <img src="../assets/images/users/{{ $personne->image_student }}" alt="user"
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-style-none mt-4">
                                    <li>
                                        ...
                                        <span
                                            class="text-dark float-end font-weight-medium">{{ $personne->student_id }}</span>
                                    </li>
                                    <li class="mt-2">
                                        <span class="text-muted">Nom</span>
                                        <span
                                            class="text-dark float-end font-weight-medium text-uppercase">{{ $personne->student_nom }}</span>
                                    </li>
                                    <li class="mt-2">
                                        <span class="text-muted">Prénom</span>
                                        <span
                                            class="text-dark float-end font-weight-medium">{{ $personne->student_prenom }}</span>
                                    </li>
                                    <li class="mt-2">
                                        <span class="text-muted">Mention</span>
                                        <span class="text-dark float-end font-weight-medium">{{ $personne->etude_envisage }}</span>
                                    </li>
                                    <li class="mt-2">
                                        <span class="text-muted">Parcours</span>
                                        <span class="text-dark float-end font-weight-medium">{{ $personne->etude_option }}</span>
                                    </li>
                                    <li class="mt-2">
                                        <span class="text-muted">Année</span>
                                        <span class="text-dark float-end font-weight-medium">L{{ $personne->annee_etude }}</span>
                                    </li>
                                    <li class="mt-2">
