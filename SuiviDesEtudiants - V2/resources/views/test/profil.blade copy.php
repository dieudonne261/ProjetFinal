                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div style="background-color:white">
                            <img src="../assets/images/users/{{ $user->Matricule }}.jpg" alt="user" class="rounded-circle " width="300px" style="; border: 10px solid white; margin-bottom:-100px">
                        </div>

                        <div class="bg-white pt-5 shadow rounded-3">
                            <h1 class="fs-1 mt-2 pt-5">{{ $user->Matricule }}</h1>
                            <h3 class="fs-3">{{ $personne->Prenom }} {{ $personne->Nom }}</h3>
