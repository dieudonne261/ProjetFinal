                    ...
                    <div class="col-lg-5 col-md-12 align-self-center">
                        <form id="searchMatriculeForm" class="input-group">
                            <input id="searchMatricule" class="form-control custom-shadow border-0 bg-white"
                                   type="search" placeholder="Entrez Matricule à rechercher" aria-label="Search">
                                                    ...
                                                    <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="col-12 text-center">
                                                                <p class="fs-5 m-0">Ceci montre les statistiques</p>
                                                                <img src="../assets/images/guide/1.jpg"
                                                                     class="img-fluid" style="width: 700px;" alt=""
                                                                     srcset="">
                                                                <hr>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-3 text-center border-end">
                                                                    ...
                                                                    <p class="fs-5 m-0">Montrons les 3 premiers types de
                                                                        suivi</p>
                                                                </div>
                                                                <div class="col-9 text-center">
                                                                    <img src="../assets/images/guide/4.jpg"
                                                                         class="img-fluid" alt="" srcset="">
                                                                    <p class="fs-5 m-0">Statistique de suivi pendant les
                                                                        jours d'ajout</p>
                                                                </div>
                                                                <hr>
                                                                <div class="col-8 text-center">
                                                                    <img src="../assets/images/guide/5.jpg"
                                                                         class="img-fluid" alt="" srcset="">
                                                                    <p class="fs-5 m-0">Les liste suggestion des
                                                                        roles</p>
                                                                </div>
                                                                <div class="col-4 text-center">
                                                                    <img src="../assets/images/guide/6.jpg"
                                                                         class="img-fluid" alt="" srcset="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 text-center ">
                                                                    <img src="../assets/images/guide/2.jpg"
                                                                         class="img-fluid" alt="" srcset="">
                                                                    <p class="fs-5 m-0">Ce bar de recherche permet de
                                                                        trouver le profil d'un matricule</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
