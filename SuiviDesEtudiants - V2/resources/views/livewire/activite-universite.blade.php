                                ...
                                <div
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header modal-colored-header bg-dark">
                                            <h4 class="modal-title" id="myCenterModalLabel">Nouveau activité
                                                universitaire</h4>
                                            ...
                                            <form action="{{ route('activite.store') }}" method="POST"
                                                ...
                                                <div class="col-4 form-group mb-3">
                                                    ...
                                                    <input type="text" name="Type" class="form-control"
                                                           value="Université" placeholder="Types de l'activité"
                                                           readonly>
                                                </div>
                                                <div class="col-4 form-group mb-3">
                    ...
                    <div class="col-12">
                        <div class="card p-4">
                            <div class="justify-content-between row">
                                <div class="col-10">
                                    <p class=" card-title display-6">Liste Des Activités De l'Université</p>
                                </div>
                            ...
                            <h6 class="card-subtitle">
                                Bienvenue dans la section Liste Des Activités De l'Université. Cette section vous permet
                                de consulter et de gérer toutes les activités organisées par notre université. Vous
                                pouvez ajouter de nouvelles activités, mettre à jour les détails des activités
                                existantes.
                            </h6>
