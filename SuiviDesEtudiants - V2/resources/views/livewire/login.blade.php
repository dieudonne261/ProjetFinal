<div>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
             style="background:url(../img/4877010.jpg) no-repeat center center;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
            <div class="auth-box row rounded-4 shadow" style="background-color:#ffffff8f">

                <div class="col-lg-5 col-md-7 rounded-4 ps-3">
                    <div class="p-3">
                        <div class="text-center mt-3">
                            <img src="../assets/images/Suivi.png" width="200px" alt="wrapkit" class="rotate-image">
                        </div>
                        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="pwd" type="password" wire:model="password"
                ...
                <div class="col-lg-7 col-md-5 modal-bg-img rounded-4 shadow"
