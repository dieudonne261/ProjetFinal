                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="suivi_lists" class="table border table-striped table-bordered text-nowrap">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            @foreach ($suivisLists as $suivi)
                                                <tr >
                                                    ...
                                                    <td class="fs-5">
                                                        <button type="button" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#viewModal{{$suivi->id}}">
                                                        ...
                                                        <div class="modal-content modal-filled bg-dark">
                                                            ...
                                                            <div class="modal-body d-flex gap-1">
                                                                ...
                                                                <div class="my-auto">
                                                                    ...
                                                                    <p>Creé par : <a href="../matricule/{{$suivi->MatriculeAdd}}">{{$suivi->MatriculeAdd}}</a></p>
...
var seriesDataRole = [];
chartDataRole.forEach(function(series) {
    var data = [];
    series.data.forEach(function(item) {
        data.push({
            x: item.x,
...
var options = {
        ...
        var charttest = new ApexCharts(document.querySelector("#charttest"), options);
        charttest.render();
